...
public class PickUpDataTest1 {
	...
	public void testPickupDataSortingAndCounting() {
	    ...
	    List<PickupData> sortedPickupData = pickupDataList.stream()
	            .sorted(Comparator
	 ...
	 // Print sorted data
	    ...
	    for (PickupData data : sortedPickupData) {
	    ...
	    for (PickupData data : sortedPickupData) {
	        ...
	        if (!area.equals(currentArea) || !company.equals(currentCompany) || !workAreaID.equals(currentWorkAreaID)) {
	            ...
	            System.out.println("Area: " + currentArea + " (Mapped to " + currentCompany + ", Work Area ID: " + currentWorkAreaID + ") - Total Pickups: " + areaTotalPickups);
