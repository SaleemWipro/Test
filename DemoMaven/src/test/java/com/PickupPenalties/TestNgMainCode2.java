 ...
 // Helper method to print row details
    private void printRowDetails(Row row, Row headerRow, String marking, Row lowestScanTimeRow) {
        ...
        for (Cell headerCell : headerRow) {
            ...
            rowDetails.append(", ").append(headerCell.getStringCellValue()).append(": ").append(cellValue);
        }

        int scanTimeIndex = headerRow.getCell(9).getColumnIndex();
        ...
        System.out.println(rowDetails + ", Marking: " + marking + ", Lowest Scan Time: " + (lowestScanTime == -1 ? "" : lowestScanTime));
    }
